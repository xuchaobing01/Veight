...
Source Database       : veight

Target Server Type    : MYSQL
Target Server Version : 50612
File Encoding         : 65001

Date: 2017-12-12 09:18:45
*/
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('1', 'test', '', '', 'ba6e52c6faa1c79b0535811a16c0456e', '|gT5FnWz', '1445516396');
...
-- Records of cat
-- ----------------------------
INSERT INTO `cat` VALUES ('1', '人生', '4');
INSERT INTO `cat` VALUES ('2', '哲学', '0');
INSERT INTO `cat` VALUES ('3', '技术', '0');
...
-- Records of comment
-- ----------------------------
INSERT INTO `comment` VALUES ('20', '7', '0', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '1', '1', '1991935937', '1443711759');
INSERT INTO `comment` VALUES ('21', '7', '0', '2', '2', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '1991935937', '1443711792');
INSERT INTO `comment` VALUES ('22', '7', '0', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', 'w', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '1991935937', '1443712091');
INSERT INTO `comment` VALUES ('23', '7', '0', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '1991935937', '1443712171');
INSERT INTO `comment` VALUES ('25', '7', '0', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', 'a', 'a', '1991935937', '1443713184');
INSERT INTO `comment` VALUES ('26', '7', '0', 's', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', 's', '1991935937', '1443713196');
INSERT INTO `comment` VALUES ('27', '7', '0', 'd', 'd', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '1991935937', '1443713204');
INSERT INTO `comment` VALUES ('28', '6', '0', '好', '好', '好', '3054660632', '1443887006');
INSERT INTO `comment` VALUES ('29', '6', '0', 'FED', 'fd', 'F D', '1991935937', '1444451187');
...
-- Records of msg
-- ----------------------------
INSERT INTO `msg` VALUES ('1', '0', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '1', '11', '1991935937', '1443711887');
INSERT INTO `msg` VALUES ('2', '0', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '1', '1', '1991935937', '1443711896');
INSERT INTO `msg` VALUES ('3', '0', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '1', '3', '1991935937', '1443711905');
INSERT INTO `msg` VALUES ('4', '0', '2', '1', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '1991935937', '1443711914');
INSERT INTO `msg` VALUES ('5', '0', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '1', '3', '1991935937', '1443712235');
INSERT INTO `msg` VALUES ('6', '0', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '1', '55555', '1991935937', '1443712243');
INSERT INTO `msg` VALUES ('7', '0', '333', '1', '&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '1991935937', '1443712254');
INSERT INTO `msg` VALUES ('8', '0', 'dfdsfdsf', '1', 'f&lt;script&gt;alert(\'fdfd\')&lt;/script&gt;', '1991935937', '1443712265');
INSERT INTO `msg` VALUES ('9', '0', 'RER', '2', 'RER', '1991935937', '1444451323');
...
-- Records of tag
-- ----------------------------
INSERT INTO `tag` VALUES ('7', '0', 'Justin Bie');
INSERT INTO `tag` VALUES ('6', '0', 'mv');
INSERT INTO `tag` VALUES ('1', '0', '北京');
INSERT INTO `tag` VALUES ('3', '0', '北京');
INSERT INTO `tag` VALUES ('5', '0', '天堂');
INSERT INTO `tag` VALUES ('2', '0', '景点');
INSERT INTO `tag` VALUES ('4', '0', '景点');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('2', '1', '男', '北京', '1', '2cf28b894ead0c0438aeef4a1b0381fd', 'A4h7G$uc', '1', '1443713170');
INSERT INTO `user` VALUES ('7', '2', '男', '北京', '2', 'c2d6a875f607fdbc952aa5ab644103d8', 'gQ3vtgz7', '2', '1444451176');
INSERT INTO `user` VALUES ('11', 'fengcaiyiyi', '男', '北京', '995360738@qq.om', '695fac66d0a0da88819da17d5ac83f37', 'wEhvzPGu', '', '1444971606');
